...
int main ()
{
	...
	slab.addGrunItem("Unitless - Excavator","8","","hour(s)","/2");
	// slab.addGrunItem("Delivery - Sub Grade","1","","delivery(ies)","*0.5");
	slab.addGrunItem("Volume - Subgrade - Fines","0.05 * A","","m3","/2");
	// slab.addGrunItem("Delivery - Steel","1","","delivery(ies)","*0.5");
	slab.addGrunItem("Linear - Ableflex - 10mm x 100mm, Stick Backed","2W","/25","roll(s)","*0.5");
	slab.addGrunItem("LCI - Dowel R12 450 HDG","2L1W@0.6","","bar(s)","/ 14");
	slab.addGrunItem("Area - Mesh SL92", "1L*1W","/ 12.5","mat(s)","* 0.66");
	...
	slab.addGrunItem("LCI to Linear - RW1 Prop Bars N12", "1.2/1L@1.2", "", "m?", "");
