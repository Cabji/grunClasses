...
std::string spatialExponentValueToString(SpatialExponentValue exponent)
{
	switch (exponent)
    {
        case SpatialExponentValue::Unitless:
            return "Unitless";
        case SpatialExponentValue::Linear:
            return "Linear";
        case SpatialExponentValue::Area:
            return "Area";
        case SpatialExponentValue::Volume:
            return "Volume";
        default:
            // This case handles unexpected or uninitialized values
            return "UNKNOWN";
    }
}
